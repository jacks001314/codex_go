...
func rustAppServerV2SuiteManifest() []rustAppServerV2SuiteCase {
	return []rustAppServerV2SuiteCase{
		...
		{Module: "command_exec", Owner: "appserver", Focus: "command/exec RPC and output streaming"},
		{Module: "compaction", Owner: "compact, turn", Focus: "thread compaction flow"},
		{Module: "config_rpc", Owner: "config, appserver", Focus: "config read/write/requirements RPCs"},
		...
		{Module: "executor_skills", Owner: "prompt, plugin", Focus: "executor-scoped skills"},
		...
		{Module: "external_agent_config", Owner: "appserver", Focus: "external agent config detect/import"},
		...
		{Module: "hooks_list", Owner: "appserver, tool", Focus: "hooks/list RPC"},
		...
		{Module: "plugin_install", Owner: "plugin", Focus: "plugin/install RPC"},
		...
		{Module: "process_exec", Owner: "appserver", Focus: "process/spawn stdio/pty lifecycle"},
