...
var keymapActionCatalog = []KeymapAction{
	...
	keymapAction("chat", "Chat", "toggle_voice_mute", "Toggle the microphone in an active voice conversation.", []string{"ctrl-x"}),
	...
	keymapAction("chat", "Chat", "edit_queued_message", "Move up through questions, then edit the last queued message.", []string{"alt-up", "shift-left"}),
	keymapAction("chat", "Chat", "prompt_stack_back", "Move back through questions toward the composer.", []string{"alt-down", "shift-right"}),
	keymapAction("chat", "Chat", "skip_question", "Skip the focused question.", []string{"ctrl-]"}),
	...
	keymapAction("vim_normal", "Vim normal", "search_backward", "Search backward for a query in the draft.", []string{"?"}),
	keymapAction("vim_normal", "Vim normal", "search_next", "Jump to the next search match.", []string{"n"}),
	keymapAction("vim_normal", "Vim normal", "search_prev", "Jump to the previous search match.", []string{"shift-n", "N"}),
	keymapAction("vim_normal", "Vim normal", "jump_top", "Jump to the first line of the buffer.", []string{"g"}),
	keymapAction("vim_normal", "Vim normal", "jump_bottom", "Jump to the last line of the buffer.", []string{"shift-g", "G"}),
	...
	keymapAction("vim_operator", "Vim operator", "motion_jump_top", "Operator motion to the first buffer line.", []string{"g"}),
	keymapAction("vim_operator", "Vim operator", "motion_jump_bottom", "Operator motion to the last buffer line.", []string{"shift-g", "G"}),
	...
	keymapAction("agents", "Agents", "archive", "Archive the selected task and its child agents.", []string{"ctrl-e"}),
