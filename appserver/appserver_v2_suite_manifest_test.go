...
func rustAppServerV2SuiteManifest() []rustAppServerV2SuiteCase {
	return []rustAppServerV2SuiteCase{
		...
		{Module: "daemon_update_recovery", Owner: "appserverdaemon, install", Focus: "managed daemon update recovery and reexec handoff"},
		...
		{Module: "mcp_protocol_default", Owner: "mcp", Focus: "per-server MCP protocol mode defaulting"},
		...
		{Module: "memory_read", Owner: "memories", Focus: "memory read/status RPC and memory v2 readiness"},
		...
		{Module: "thread_attachments", Owner: "state, appserver", Focus: "thread attachment add/list/remove RPCs and notifications"},
		...
		{Module: "thread_fork_multi_agent", Owner: "session, agent", Focus: "fork runtime versions and multi-agent version preservation"},
		{Module: "thread_goal_empty_responses", Owner: "state, appserver", Focus: "thread goal empty-response continuation handling"},
		...
		{Module: "user_verification", Owner: "user-verification, appserver", Focus: "userVerification status/enroll/delete/verify/cancel RPCs"},
		{Module: "user_verification_mcp", Owner: "user-verification, mcp, appserver", Focus: "MCP-scoped user verification transport and identity"},
