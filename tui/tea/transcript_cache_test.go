...
func TestRenderTranscriptCacheReusesUnchangedMessages(t *testing.T) {
	...
	first := renderTranscriptWithCache(&cache, state, false, 80, "dark", false, "", false)
	...
	second := renderTranscriptWithCache(&cache, state, false, 80, "dark", false, "", false)
	...
	third := renderTranscriptWithCache(&cache, state, false, 80, "dark", false, "", false)
	if third != second {
...
func TestRenderTranscriptCacheReflectsDirectMutation(t *testing.T) {
	...
	var cache transcriptMessageCache
	first := renderTranscriptWithCache(&cache, state, false, 80, "dark", true, "", false)
	...
	second := renderTranscriptWithCache(&cache, state, false, 80, "dark", true, "", false)
