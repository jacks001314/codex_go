...
This page is a supplement to [Go Code Review Comments](/wiki/CodeReviewComments), but is targeted specifically to test code.
...
[Table-driven](/wiki/TableDrivenTests) tests should be used whenever many different test cases can be tested using similar testing logic, for example when testing whether the actual output of a function is equal to the expected output [example](TableDrivenTests#example-of-a-table-driven-test), or when testing whether the outputs of a function always conform to the same set of invariants.
