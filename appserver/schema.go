...
func experimentalClientRequestMethods() []ProtocolMethod {
	return []ProtocolMethod{
		...
		{Method: string(MethodMCPServerEventStreamStart), Experimental: true},
		{Method: string(MethodMCPServerEventStreamStop), Experimental: true},
		{Method: string(MethodMemoryReset), Experimental: true},
		{Method: string(MethodRolloutCompress), Experimental: true},
		...
		{Method: string(MethodThreadRevert), Experimental: true},
		{Method: string(MethodThreadQueueAdd), Experimental: true},
		{Method: string(MethodThreadQueueList), Experimental: true},
		{Method: string(MethodThreadQueueUpdate), Experimental: true},
		{Method: string(MethodThreadQueueDelete), Experimental: true},
		{Method: string(MethodThreadQueueReorder), Experimental: true},
		{Method: string(MethodThreadQueueStart), Experimental: true},
		...
		{Method: string(MethodMemoryStatus), Experimental: true},
...
func notificationMethods(includeExperimental bool) []ProtocolMethod {
	methods := []ProtocolMethod{
		...
		{Method: string(NotificationAuthRecoveryCompleted)},
		...
		{Method: string(NotificationStrictReviewRequired)},
		...
		{Method: string(NotificationMCPServerEventStream), Experimental: true},
		...
		{Method: string(NotificationProjectChanged), Experimental: true},
		...
		{Method: string(NotificationThreadAttachmentUpdated)},
		{Method: string(NotificationThreadNameUpdated)},
		{Method: string(NotificationThreadQueueChanged)},
		...
		{Method: string(NotificationThreadRealtimeItemStarted), Params: "ThreadRealtimeItemStartedNotification"},
		{Method: string(NotificationThreadRealtimeItemCompleted), Params: "ThreadRealtimeItemCompletedNotification"},
		{Method: string(NotificationThreadRealtimeItemTranscriptDelta), Params: "ThreadRealtimeItemTranscriptDeltaNotification"},
		...
		{Method: string(NotificationThreadProjectUpdated), Experimental: true},
		{Method: string(NotificationThreadReverted)},
...
func protocolMethodSignatures() map[string]protocolMethodSignature {
	return map[string]protocolMethodSignature{
		...
		string(MethodRolloutCompress):                        {Result: "RolloutCompressResponse"},
		string(MethodMemoryStatus):                           {Params: "MemoryStatusParams", Result: "MemoryStatusResponse"},
		...
		string(MethodThreadAttachmentAdd):                    {Params: "ThreadAttachmentAddParams", Result: "ThreadAttachmentAddResponse"},
		string(MethodThreadAttachmentList):                   {Params: "ThreadAttachmentListParams", Result: "ThreadAttachmentListResponse"},
		string(MethodThreadAttachmentRemove):                 {Params: "ThreadAttachmentRemoveParams", Result: "ThreadAttachmentRemoveResponse"},
		...
		string(MethodThreadRevert):                           {Params: "ThreadRevertParams", Result: "ThreadRevertResponse"},
		string(MethodThreadQueueAdd):                         {Params: "ThreadQueueAddParams", Result: "ThreadQueueAddResponse"},
		string(MethodThreadQueueList):                        {Params: "ThreadQueueListParams", Result: "ThreadQueueListResponse"},
		string(MethodThreadQueueUpdate):                      {Params: "ThreadQueueUpdateParams", Result: "ThreadQueueUpdateResponse"},
		string(MethodThreadQueueDelete):                      {Params: "ThreadQueueDeleteParams", Result: "ThreadQueueDeleteResponse"},
		string(MethodThreadQueueReorder):                     {Params: "ThreadQueueReorderParams", Result: "ThreadQueueReorderResponse"},
		string(MethodThreadQueueStart):                       {Params: "ThreadQueueStartParams", Result: "ThreadQueueStartResponse"},
		...
		string(MethodThreadSectionCreate):                    {Params: "ThreadSectionCreateParams", Result: "ThreadSectionCreateResponse"},
		string(MethodThreadSectionUpdate):                    {Params: "ThreadSectionUpdateParams", Result: "ThreadSectionUpdateResponse"},
		string(MethodThreadSectionDelete):                    {Params: "ThreadSectionDeleteParams", Result: "ThreadSectionDeleteResponse"},
		...
		string(NotificationAuthRecoveryCompleted):               {Params: "AuthRecoveryNotification"},
		...
		string(NotificationStrictReviewRequired):                {Params: "StrictReviewRequiredNotification"},
		...
		string(NotificationMCPServerEventStream):                {Params: "McpServerEventStreamNotification"},
		...
		string(NotificationProjectChanged):                      {Params: "ProjectChangedNotification"},
		...
		string(NotificationThreadAttachmentUpdated):             {Params: "ThreadAttachmentUpdatedNotification"},
		string(NotificationThreadNameUpdated):                   {Params: "ThreadNameUpdatedNotification"},
		string(NotificationThreadQueueChanged):                  {Params: "ThreadQueueChangedNotification"},
		...
		string(NotificationThreadRealtimeItemStarted):           {Params: "ThreadRealtimeItemStartedNotification"},
		string(NotificationThreadRealtimeItemCompleted):         {Params: "ThreadRealtimeItemCompletedNotification"},
		string(NotificationThreadRealtimeItemTranscriptDelta):   {Params: "ThreadRealtimeItemTranscriptDeltaNotification"},
		...
		string(NotificationThreadProjectUpdated):                {Params: "ThreadProjectUpdatedNotification"},
		string(NotificationThreadReverted):                      {Params: "ThreadRevertedNotification"},
